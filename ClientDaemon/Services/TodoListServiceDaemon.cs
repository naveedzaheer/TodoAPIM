...
{
    public static class TodoListServiceDaemonExtensions
    {
        public static void AddTodoListServiceDaemon(this IServiceCollection services, IConfiguration configuration)
        {
            // https://docs.microsoft.com/en-us/dotnet/standard/microservices-architecture/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests
            services.AddHttpClient<ITodoListService, TodoListServiceDaemon>();
        }
    }
    /// <summary></summary>
    /// <seealso cref="TodoListClient.Services.ITodoListService" />
    public class TodoListServiceDaemon : ITodoListService
    {
        ...
        public TodoListServiceDaemon(HttpClient httpClient, IConfiguration configuration, IHttpContextAccessor contextAccessor)
        {
        ...
        private async Task PrepareAuthenticatedClient()
        {
            ...
            IConfidentialClientApplication app = ConfidentialClientApplicationBuilder.Create(_configuration["AzureAd:ClientId"])
                    ...
                    .Build();
            var result = await app.AcquireTokenForClient(new[] { _TodoListScope }).ExecuteAsync();
